...
<div class="menu">
	<div class="menu_container text-right">
		...
		<nav class="menu_nav">
			<ul>
				<li><a href="SAAL_faculty.php">Home</a></li>
				<li><a href="#">About us</a></li>
				<li><a href="listings_faculty.php">Books</a></li>
			...
			<div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
				<nav class="main_nav">
					<ul class="d-flex flex-row align-items-center justify-content-start">
						<li class="active"><a href="SAAL_faculty.php">Home</a></li>
						<li><a href="listings_faculty.php">Books</a></li>
					</ul>
				</nav>
				<div class="add_listing text-center trans_200"><a href="return_book_faculty.php">-Return Book</a></div>
				<div class="add_listing text-center trans_200"><a href="borrow_book_faculty.php">+Borrow Book</a></div>
				<div class="log_reg">
					<ul class="d-flex flex-row align-items-center justify-content-start">
			...
			<div class="container">
				<div class="row">
					...
					try{
						...
						$stmt1 = "CREATE VIEW faculty_genres AS (SELECT count(*) AS counta,genre FROM faculty,Borrows,book WHERE Email='".$_COOKIE["Email"]."' AND password='".$_COOKIE["Password"]."' AND fid_borrows=fid AND Book_id_borrows=Book_id AND type='Fiction' GROUP BY genre)";
						$stmt1 = $conn->query($stmt1);
						$stmt2="SELECT DISTINCT book_name FROM book WHERE genre IN (SELECT DISTINCT genre FROM faculty_genres WHERE counta>=ALL(SELECT counta FROM faculty_genres))";
						...
						$stmt3="DROP VIEW faculty_genres";
			...
			<div class="container">
				<div class="row">
					...
					try{
						...
						//querying database for table values
						$stmt = "SELECT DISTINCT book_name FROM faculty,book WHERE Email='".$_COOKIE["Email"]."' AND password='".$_COOKIE["Password"]."'
								 AND type='Educational' AND LEFT(Did_fac,9)=LEFT(Did_book,9)"; 
						$stmt = $conn->query($stmt);
						$no = 0;
			...
			<div class="container">
				<div class="row">
					...
					try{
						...
						$stmt = $conn->query($stmt);
						$stmt1 = "SELECT book_name,overdue_fees FROM borrows,book,faculty WHERE overdue_fees>0 AND book_id=Book_id_borrows AND fid=fid_borrows AND Email='".$_COOKIE["Email"]."' AND password='".$_COOKIE["Password"]."'";
						$stmt1 = $conn->query($stmt1);
						$stmt2= "SELECT SUM(overdue_fees) AS total FROM borrows,book,faculty WHERE overdue_fees>0 AND book_id=Book_id_borrows AND fid=fid_borrows AND Email='".$_COOKIE["Email"]."' AND password='".$_COOKIE["Password"]."'";
						$stmt2 = $conn->query($stmt2);
						$no = 0;
			...
			<div class="container">
				<div class="row">
					...
					try{
						...
						//querying database for table values
						$stmt = "SELECT book_name,rating FROM book,faculty WHERE Email='".$_COOKIE["Email"]."' AND password='".$_COOKIE["Password"]."' AND branch_id_fac=branch_id_book ORDER BY rating";
						$stmt = $conn->query($stmt);
