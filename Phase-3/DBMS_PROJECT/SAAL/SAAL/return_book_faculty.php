...
<div class="menu">
	<div class="menu_container text-right">
		...
		<div class="menu_link">
			<a href="return_book_faculty.php">-Return Book</a>
			<a href="borrow_book_faculty.php">+Borrow Book</a>
		</div>
	</div>
</div>
			...
			<div class="header_right d-flex flex-row align-items-center justify-content-start ml-auto">
				<nav class="main_nav">
					<ul class="d-flex flex-row align-items-center justify-content-start">
						<li><a href="SAAL_faculty.php">Home</a></li>
						<li class="active"><a href="listings_faculty.php">Books</a></li>
					</ul>
				</nav>
			...
			<div class="container">
				<div class="row">
					...
					try{
						...
						$stmt= "SELECT book_name,book_id FROM book,faculty,borrows WHERE Email='".$_COOKIE["Email"]."' AND password='".$_COOKIE["Password"]."' AND fid=fid_borrows and book_id=book_id_borrows";
...
<?php
		$host = "localhost";
					...
					try{
						...
						//$stmt1 = $conn->query($stmt1);
						$stmt1 = "UPDATE book set is_borrowed=FALSE WHERE book_id IN (SELECT book_id FROM book,faculty WHERE book_name='".$_POST["book"]."' AND Email='".$_COOKIE["Email"]."' AND password='".$_COOKIE["Password"]."')";
						$stmt1 = $conn->query($stmt1);
						$stmt2 = "DELETE FROM borrows WHERE book_id_borrows IN (SELECT book_id FROM book,faculty,borrows WHERE book_name='".$_POST["book"]."' AND Email='".$_COOKIE["Email"]."' AND password='".$_COOKIE["Password"]."' AND book_id_borrows=book_id AND fid_borrows=fid)"; 
						$stmt2 = $conn->query($stmt2);
