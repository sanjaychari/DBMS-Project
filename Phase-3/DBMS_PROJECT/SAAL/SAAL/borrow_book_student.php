			...
			<div class="container">
				<div class="row">
					...
					try{
						...
						$stmt= "SELECT book_name,book_id FROM book,student WHERE Email='".$_COOKIE["Email"]."' AND password='".$_COOKIE["Password"]."' AND branch_id_stud=branch_id_book AND book_id NOT IN (SELECT book_id_borrows FROM BORROWS)";
...
<?php
		$host = "localhost";
					...
					try{
						...
						//$stmt1 = $conn->query($stmt1);
						$stmt1 = "SELECT * FROM book,student,branch WHERE book_name='".$_POST["book"]."' AND Email='".$_COOKIE["Email"]."' AND password='".$_COOKIE["Password"]."' AND branch_id_book=branch_id_stud AND book_id NOT IN (SELECT book_id_borrows FROM BORROWS)";
						$stmt1 = $conn->query($stmt1);
